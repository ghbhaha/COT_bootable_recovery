...
LOCAL_CFLAGS += -DTS_MAX_X=$(TS_MAX_X)
LOCAL_CFLAGS += -DTS_MAX_Y=$(TS_MAX_Y)
...
RECOVERY_LINKS := amend edify busybox e2fsck flash_image dump_image mkyaffs2image unyaffs erase_image mke2fs tune2fs nandroid reboot volume setprop
